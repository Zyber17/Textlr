		...
		if($loaded['errors']) {
			...
			if ($loaded['response']['code'] == 200) {
				...
				if($isplain) {
					...
					echo($loaded['data']['text']);

				}else {
					$html1 = '<!DOCTYPE html>
	<html xmlns="http://www.w3.org/1999/xhtml" lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="viewport" content="width=device-width; initial-scale=1.0; user-scalable=no; maximum-scale=1.0;" /><link rel="icon" type="image/png" href="/favicon.png" /><title>Textlr'.($title ? ': '.$title : '').'</title><link rel="stylesheet" type="text/css" href="/page.css" />'.$dark.'</head><body onload="d();"><header id="brand"><div id="center"><a href="/" title="Textlr">Textlr</a></div></header><div id="wrapper"><article>';
					if ($title) {
